...
Java_com_kronop_live_NativeRenderer_create(JNIEnv* env, jobject thiz) {
...
Java_com_kronop_live_NativeRenderer_destroy(JNIEnv* env, jobject thiz, jlong rendererPtr) {
...
JNIEXPORT void JNICALL
Java_com_kronop_live_NativeRenderer_renderFrame(JNIEnv* env, jobject thiz, jlong rendererPtr, 
...
Java_com_kronop_live_NativeRenderer_getFPS(JNIEnv* env, jobject thiz, jlong rendererPtr) {
    NativeRenderer* renderer = (NativeRenderer*)rendererPtr;
...
JNIEXPORT jlong JNICALL
Java_com_kronop_live_NativeRenderer_getMemoryUsage(JNIEnv* env, jobject thiz, jlong rendererPtr) {
    NativeRenderer* renderer = (NativeRenderer*)rendererPtr;
...
JNIEXPORT void JNICALL
Java_com_kronop_live_NativeRenderer_setNativeWindow(JNIEnv* env, jobject thiz, jlong rendererPtr, jobject surface) {
    NativeRenderer* renderer = (NativeRenderer*)rendererPtr;
    if (!renderer) return;
...
Java_com_kronop_live_NativeRenderer_decodeVideo(JNIEnv* env, jobject thiz, jlong rendererPtr, 
